    ...
    <div class="d-flex panel">
        ...
        <div class="right-panel" style="font-family:Inter;">
            <div class="form-container">
                <h2 style="font-size:36px; font-weight: 400;">Driver Log in</h2>
                ...
                <div class="signup-text">
                    Want to create an account? <a v-bind:href="'/driver/registeration'">Sign up</a>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        async onSubmit() {
            ...
            try {
                const response = await axios.post("/driver/post-login", formData, {
                    headers: {
